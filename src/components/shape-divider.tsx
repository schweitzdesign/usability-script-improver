...
export function ShapeDivider({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <circle cx="36" cy="36" r="5" fill="var(--ink)" />
      <circle cx="108" cy="28" r="14" fill="var(--forest)" />
      <path
      ...
      />
      <circle cx="380" cy="32" r="13" fill="none" stroke="var(--border)" strokeWidth="2.5" />
      <circle cx="466" cy="30" r="17" fill="var(--vermilion)" style={{ mixBlendMode: "multiply" }} />
      <circle cx="548" cy="20" r="8" fill="var(--forest)" />
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="742" cy="34" r="6" fill="var(--ink)" />
      <circle cx="770" cy="18" r="4" fill="var(--vermilion)" />
    </svg>
  );
}
